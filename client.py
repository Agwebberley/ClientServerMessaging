...
class Client:
    ...
    def process_message(self, message):
        ...
        print(f"[Client] Processing message from '{message['from']}'...")
    ...
    def run(self):
        ...
        self.register()
        self.request_contacts()
        # Example: Send a message (you can modify as needed)
        # self.send_message('bob', 'Hello, Bob!')
        # Retrieve messages
...
if __name__ == "__main__":
    ...
    private_key_file = "alice_private_key.pem"
    ...
    # To send a message (uncomment and modify as needed)
    # client.send_message('bob', 'Hello Bob, this is a secure message.')
